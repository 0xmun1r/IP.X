...
setup(
    ...
    author="Your Name/Team Name", # Replace with your name
    author_email="your.email@example.com", # Replace with your email
    description="An origin IP finder behind WAF and CDN, with WAF detection capabilities.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/your-username/IP.X", # Replace with your GitHub repository URL
    ...
    entry_points={
        'console_scripts': [
            'IP.X = ip_x.cli:main', # IMPORTANT: Points to main() in ip_x/cli.py
        ],
    },
)
